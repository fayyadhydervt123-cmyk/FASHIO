...
urlpatterns = [
    ...
    path(
        "verify-email-edit-otp",
        views.user_verify_email_edit_otp,
        name="user_verify_email_edit_otp",
    ),
    path("wallet", views.user_wallet, name="user_wallet"),
    path("wallet/add-money/", views.user_add_wallet_money, name="user_add_wallet_money"),
    path(
        "wallet/payment-success/",
        views.user_wallet_payment_success,
        name="user_wallet_payment_success",
    ),
]